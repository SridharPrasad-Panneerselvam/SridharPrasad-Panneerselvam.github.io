...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./node_modules/@angular/platform-browser/__ivy_ngcc__/fesm2015/animations.js"); //import { HashLocationStrategy, LocationStrategy } from '@angular/common';
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: [".mainpage[_ngcontent-%COMP%] {\n  background: url('Pic10.jpg') center center/cover;\n  height: 760px;\n  left: 0;\n  top: 0;\n  position: absolute;\n  width: 100vw;\n}\n\n.name[_ngcontent-%COMP%] {\n  top: 200px;\n}\n\n.name[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  position: absolute;\n  width: 100%;\n  text-align: center;\n  top: 200px;\n  color: rgba(245, 237, 237, 0.918);\n  font-family: \"Trebuchet MS\", Helvetica, sans-serif;\n  letter-spacing: 0.7em;\n  font-size: 25pt;\n  font-weight: 200;\n  text-transform: uppercase;\n  bottom: 20px;\n}\n\n.designation[_ngcontent-%COMP%] {\n  margin-top: 320px;\n}\n\n.designation[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  position: absolute;\n  width: 100%;\n  text-align: center;\n  color: white;\n  font-family: \"Trebuchet MS\", Helvetica, sans-serif;\n  letter-spacing: 0.4em;\n  font-size: 1.5vw;\n  font-weight: 1200;\n  opacity: 0.2;\n  text-transform: lowercase;\n}\n\n@keyframes fade_text {\n  0% {\n    opacity: 1;\n  }\n  10% {\n    opacity: 0.8;\n  }\n  25% {\n    opacity: 0.5;\n  }\n  50% {\n    opacity: 0.3;\n  }\n  65% {\n    opacity: 0.5;\n  }\n  90% {\n    opacity: 0.8;\n  }\n  100% {\n    opacity: 1;\n  }\n}\n\n@-webkit-keyframes fade_text {\n  0% {\n    opacity: 1;\n  }\n  10% {\n    opacity: 0.8;\n  }\n  25% {\n    opacity: 0.5;\n  }\n  50% {\n    opacity: 0.3;\n  }\n  65% {\n    opacity: 0.5;\n  }\n  90% {\n    opacity: 0.8;\n  }\n  100% {\n    opacity: 1;\n  }\n}\n\n.text_fade[_ngcontent-%COMP%] {\n  -webkit-animation: fade_text 8s infinite ease-in;\n  animation: fade_text 8s infinite ease-in;\n}\n\n.mainpage[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  justify-content: center;\n  position: relative;\n  display: inline-block;\n  margin-top: 150px;\n  padding: 1rem 4rem 1rem 2rem;\n  width: 200px;\n  height: 50px;\n  text-align: center;\n  background-color: inherit;\n  left: 42.5%;\n  font-size: 15pt;\n  font-family: \"Trebuchet MS\", Helvetica, sans-serif;\n  line-height: 2rem;\n  border-radius: 2px;\n  cursor: pointer;\n  transition: all 0.5s ease;\n}\n\n.mainpage[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:hover {\n  border-color: rgba(255, 255, 255, 0.486);\n  background-color: rgba(255, 255, 255, 0.123);\n  text-decoration: none;\n}\n\n.mainpage[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  position: absolute;\n  right: 1.6rem;\n  top: 1.45rem;\n  text-decoration: none;\n}\n\n.navbar[_ngcontent-%COMP%] {\n  background-color: red;\n  font-family: \"Roboto\", sans-serif;\n}\n\n.navbar[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  text-decoration: none;\n  color: black;\n  border-radius: 2.5em;\n  padding: 1em;\n  margin: 0.5em;\n  cursor: pointer;\n}\n\n.navbar[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover {\n  background-color: red;\n  color: white;\n}\n\n.navbar[_ngcontent-%COMP%]   .active[_ngcontent-%COMP%] {\n  background-color: red;\n  color: red;\n}\n\n.link[_ngcontent-%COMP%] {\n  margin-top: 5%;\n}\n\n.link[_ngcontent-%COMP%]   .fa-linkedin[_ngcontent-%COMP%] {\n  transform: scale(1.1);\n  color: #3376b0;\n  transition: 0.4s all;\n  cursor: pointer;\n}\n\n.link[_ngcontent-%COMP%]   .fa-instagram[_ngcontent-%COMP%] {\n  transform: scale(1.1);\n  color: #ac1453;\n  transition: 0.4s all;\n  cursor: pointer;\n}\n\n.link[_ngcontent-%COMP%]   .fa-github[_ngcontent-%COMP%] {\n  transform: scale(1.1);\n  transition: 0.4s all;\n  color: #4e4b4b;\n  cursor: pointer;\n}\n\n.link[_ngcontent-%COMP%]   .fa-facebook-square[_ngcontent-%COMP%] {\n  transform: scale(1.1);\n  color: #3b5998;\n  transition: 0.4s all;\n  cursor: pointer;\n}\n\n.link[_ngcontent-%COMP%]   .fa-map-marker[_ngcontent-%COMP%] {\n  transform: scale(1.1);\n  color: #158b05;\n  transition: 0.4s all;\n  cursor: pointer;\n}\n\n.link[_ngcontent-%COMP%]   .fa-twitter[_ngcontent-%COMP%] {\n  transform: scale(1.1);\n  color: #38A1F3;\n  transition: 0.4s all;\n  cursor: pointer;\n}\n\n.link[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  margin-left: 11.5%;\n  color: #1b242f;\n  cursor: pointer;\n}\n\n.links[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:visited {\n  color: #1b242f;\n}\n\n.horizontal-flip-hover[_ngcontent-%COMP%] {\n  text-indent: -100em;\n}\n\n.horizontal-flip-hover[_ngcontent-%COMP%]:before, .horizontal-flip-hover[_ngcontent-%COMP%]:after {\n  display: block;\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  text-indent: 0;\n  -webkit-backface-visibility: hidden;\n  backface-visibility: hidden;\n  transition: all 0.4s ease-in-out;\n}\n\n.horizontal-flip-hover[_ngcontent-%COMP%]:before {\n  content: attr(data-front);\n  z-index: 2;\n  color: rgba(255, 255, 255, 0.486);\n  padding-top: 3%;\n}\n\n.horizontal-flip-hover[_ngcontent-%COMP%]:hover:before {\n  z-index: 1;\n  transform: rotateX(180deg);\n}\n\n.horizontal-flip-hover[_ngcontent-%COMP%]:after {\n  content: attr(data-back);\n  z-index: 1;\n  transform: rotateX(-180deg);\n  padding-top: 3%;\n  background-color: rgba(255, 255, 255, 0.123);\n}\n\n.horizontal-flip-hover[_ngcontent-%COMP%]:hover:after {\n  z-index: 2;\n  transform: rotateX(0deg);\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
